...
function request_plot(~, ~, serialport)
    ...
    global beam_parameters;                         % Refer to the global parameter vector
...
function request_params(~, ~, serialport)
    ...
    beam_str = {'COMPUTED BEAM PARAMETERS ',['********************************************************************'] , ...
        ...
        [],...
        ['Peak left edge   :                             ' num2str(beam_parameters(2)) '                           ' num2str(beam_parameters(5))], ...
        [],...
        ['Peak centre      :                              ' num2str(beam_parameters(1)) '                           ' num2str(beam_parameters(4))], ...
        [],...
        ['Peak right edge      :                        ' num2str(beam_parameters(3)) '                           ' num2str(beam_parameters(6))], ...
        [],...
        ['Beam intensity        :                       ' num2str(beam_parameters(7)) '                         ' num2str(beam_parameters(8))], ...
        [],...
